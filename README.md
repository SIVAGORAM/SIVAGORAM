...
### ☁️ Cloud Microservices Infrastructure
Automated CI/CD deployment pipeline with containerization and GitOps sync.
**Zero-downtime releases & automated build pipelines**
`AWS EKS` `Docker` `Terraform` `ArgoCD` `GitHub Actions`
...
I'm open to **Full Stack Engineer / Cloud DevOps Engineer / AI Engineer** roles — collaborative teams building products that matter.
